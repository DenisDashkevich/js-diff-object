...
describe('diff util spec', () => {
    ...
    it('should show diff for arrays', () => {
        const prev = { a: 12, b: { s: { w: { q: 'pabswq', l: [1,2,3,4] } } } };
        const next = { a: 12, b: { s: { w: { q: 'pabswq', l: [1,2,3,2] } } } };
    ...
    it('should show diff for functions', () => {
        const prev = { a: 12, b: { s: { w: { q: 'pabswq', l: [1,2,3,4] } } }, l: () => {} };
        const next = { a: 12, b: { s: { w: { q: 'pabswq', l: [1,2,3,4] } } }, l: () => {} };
